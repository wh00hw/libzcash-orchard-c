...
static inline void blake2b_G(uint64_t* v, const uint64_t* m, const uint8_t* s, int i) {
    // Column/diagonal mixing indices
    static const uint8_t idx[8][4] = {
        {0,4,8,12}, {1,5,9,13}, {2,6,10,14}, {3,7,11,15},
        {0,5,10,15}, {1,6,11,12}, {2,7,8,13}, {3,4,9,14}
    };
    uint8_t a = idx[i][0], b = idx[i][1], c = idx[i][2], d = idx[i][3];
    v[a] = v[a] + v[b] + m[s[2*i+0]];
